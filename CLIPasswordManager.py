...
class PasswordManager:
    ...
    def set_password(self, password: str, salt: bytes = b""):
        """Method for hashing and setting master password for csv file and salt file"""
        if salt is None:
            salt = os.urandom(16)
        self.salt = salt
        kdf = PBKDF2HMAC(
                    ...
                    # Option 2: Adding to database
                        ...
                        while True:
                            try:
                                ...
                                entry = input(
                                    "Which would you like to open? Choose a number or exit to return to Main Menu. \n"
                                )
